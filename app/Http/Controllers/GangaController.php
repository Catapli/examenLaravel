...
class GangaController extends Controller
{
    ...
    public function index()
    {
        ...
        $gangas->all();
        return view('products.index',compact('gangas','categories')); }
    ...
    public function show($id)
    {
        $ganga = Ganga::find($id);
        $categories = Category::all();
        return view('products.show',compact('ganga','categories'));
    }
    ...
    public function edit($id)
    {
        $ganga = Ganga::find($id);
        $categories = Category::all();
        return view('products.edit',compact('ganga','categories'));
    }
    ...
    public function destroy($id)
    {
        ...
        return view('index', compact('categories','gangas'));
    }
}
