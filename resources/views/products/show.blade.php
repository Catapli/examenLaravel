    ...
    <div class="col-xl-3 col-lg-4 col-md-4 col-12">
        <div class="single-product">
            ...
            <div class="product-content">
                ...
                <br>
                <button type="button" class="btn btn-secondary"> <a href="{{route('products.delete',$ganga->id)}}"><i class="bi bi-trash"></i>delete</a></button>
                <button type="button" class="btn btn-secondary">    <a href="{{route('products.edit',$ganga->id)}}"><i class="bi bi-pencil"></i>edit</a></button>
